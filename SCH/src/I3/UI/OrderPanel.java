  ...
  //  OrderDb orderDb = new OrderDb();
        ...
        editor.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent evt)
            {
                ...
                if(evt.getKeyChar() == KeyEvent.VK_ENTER)
                {
                    ...
                    if(!details.contains(","))
                    {
                        JOptionPane.showMessageDialog(null, "no se encontró reserva, intente agregar una nueva reserva");
                    }
                    else
                    {
    ...
    public void bookingComboFill(ResultSet result)
    {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Combo fallidor");
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(combo_booking, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
